...
namespace MultiTenant.Api.Migrations
{
    ...
    [Migration("20260421223447_ExpenseRequestFundingExpenseProject")]
    partial class ExpenseRequestFundingExpenseProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequest", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ExpenseRequestId");
            ...
            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequestApproval", b =>
                {
                    b.Property<Guid>("ExpenseRequestApprovalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ExpenseRequestApprovalId");

                    b.HasIndex("ApproverUserId");

                    b.HasIndex("ExpenseRequestId", "StepSequence")
                        .IsUnique();

                    b.HasIndex("TenantId", "ExpenseRequestId");

                    b.ToTable("ExpenseRequestApprovals", (string)null);
                });

            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequestLine", b =>
                {
                    b.Property<Guid>("ExpenseRequestLineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExpenseRequestId", "SequenceOrder")
                        .IsUnique();

                    b.HasIndex("TenantId", "ExpenseRequestId");

                    b.ToTable("ExpenseRequestLines", (string)null);
                });

            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequestSequence", b =>
                {
                    b.Property<Guid>("ExpenseRequestSequenceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ExpenseRequestSequenceId");

                    b.HasIndex("TenantId", "Year")
                        .IsUnique();

                    b.ToTable("ExpenseRequestSequences", (string)null);
                });
            ...
            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequest", b =>
                {
                    ...
                    b.HasOne("MultiTenant.Api.Domain.Entities.Vendor", "Vendor")
                        .WithMany()
            ...
            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequestApproval", b =>
                {
                    ...
                    b.HasOne("MultiTenant.Api.Domain.Entities.ExpenseRequest", "ExpenseRequest")
                        .WithMany("Approvals")
            ...
            modelBuilder.Entity("MultiTenant.Api.Domain.Entities.ExpenseRequestLine", b =>
                {
                    b.HasOne("MultiTenant.Api.Domain.Entities.ExpenseCategory", "LineExpenseCategory")
                        .WithMany()
                        .HasForeignKey("ExpenseCategoryId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("MultiTenant.Api.Domain.Entities.Vendor", "LineVendor")
                        .WithMany()
                        .HasForeignKey("VendorId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("LineExpenseCategory");

                    b.Navigation("LineVendor");
                });
